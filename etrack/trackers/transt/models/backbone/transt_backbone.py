...
from ...utils.msic import NestedTensor
from ..neck.position_encoding import build_position_encoding
...
class Backbone(BackboneBase):
    ...
    def __init__(self,
                 ...
                 pretrained,
                 frozen_layers):
        backbone = resnet50(output_layers=output_layers, pretrained=pretrained,
