...
class BaseBackbone(nn.Module):
    ...
    def finetune_track(self, cfg, patch_start_index=1):
        ...
        search_size = to_2tuple(cfg.search_size)
        template_size = to_2tuple(cfg.template_size)
        new_patch_size = cfg.stride

        self.cat_mode = cfg.cat_mode
        self.return_inter = cfg.return_inter
        self.return_stage = cfg.return_stages
        self.add_sep_seg = cfg.sep_seg
